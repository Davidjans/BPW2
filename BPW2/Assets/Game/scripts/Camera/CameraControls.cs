...
public class CameraControls : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        {
            transform.Translate(Vector3.forward * m_MovementSpeed * (m_Movement.y * Time.deltaTime), Space.Self);
            transform.Translate(Vector3.right * m_MovementSpeed * (m_Movement.x * Time.deltaTime), Space.Self);

            if (Input.mousePosition.y >= Screen.height - m_BorderThickness && m_MouseMovementEnabled)
            {
                transform.Translate(Vector3.forward * m_MovementSpeed * Time.deltaTime, Space.Self);
            }
            ...
            {
                transform.Translate(-Vector3.right * m_MovementSpeed * Time.deltaTime, Space.Self);
            }
