...
float3 GetTessFactors ()
{
   ...
   return 0;
    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        // when instancing is enabled, we need to flip the normal and I don't understand why.
        // everything looks correct with the TBN matrix, but the y is flipped on the normal.
        // I hate, hate this. 
        #if (defined(UNITY_INSTANCING_ENABLED) && _MICROTERRAIN)
            l.Normal.y *= -1;
        #endif
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat_Base-828976062"
   Fallback "Hidden/MicroSplat_Base-828976062"
